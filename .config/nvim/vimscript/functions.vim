...
" Fortune function ported from startify
" TODO convert to LUA
let g:predefined_quotes = [
...
function! Quote() abort
    let l:max = len(g:predefined_quotes)
    let l:ind = str2nr(matchstr(reltimestr(reltime()), '\.\zs\d\+')[1:]) % l:max
    let l:str = g:predefined_quotes[l:ind]
    return l:str
endfunction
