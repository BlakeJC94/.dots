...
_G.packer_plugins = {
  ...
  ["focus.nvim"] = {
    ...
    loaded = true,
    path = "/home/blake/.local/share/nvim/site/pack/packer/start/focus.nvim"
  },
  ["friendly-snippets"] = {
    loaded = true,
  ...
  ["splitjoin.vim"] = {
    loaded = true,
    path = "/home/blake/.local/share/nvim/site/pack/packer/start/splitjoin.vim"
  },
  ["targets.vim"] = {
    loaded = true,
  ...
  ["which-key.nvim"] = {
    ...
    loaded = true,
    path = "/home/blake/.local/share/nvim/site/pack/packer/start/which-key.nvim"
  },
  ["zen-mode.nvim"] = {
