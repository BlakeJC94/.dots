...
M.load_plugins = function()
    ...
    local modules = {
        ...
        require('plugins.modules.git'),
        require('plugins.modules.lir'),
        ...
        require('plugins.enhancements.editor'),
        require('plugins.enhancements.interface'),
        require('plugins.enhancements.window'),
    }
