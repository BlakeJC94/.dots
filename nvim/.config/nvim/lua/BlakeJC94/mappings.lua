...
local mappings = {
    ...
    { "n", "<C-Left>", function() require("smart-splits").resize_left(8) end},
    { "n", "<C-Up>", function() require("smart-splits").resize_up(4) end},
    { "n", "<C-Down>", function() require("smart-splits").resize_down(4) end},
    { "n", "<C-Right>", function() require("smart-splits").resize_right(8) end},
